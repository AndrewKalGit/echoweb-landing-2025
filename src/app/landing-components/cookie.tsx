...
const CookieBanner = () => {
	...
	return (
		<div className='fixed bottom-4 left-4 right-4 sm:left-8 sm:right-8 z-50 bg-white border border-gray-300 rounded-lg shadow-md p-4 sm:p-6 text-sm sm:text-base flex flex-col sm:flex-row items-center justify-between gap-4'>
